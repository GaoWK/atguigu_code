...
public class OKHttpActivity extends Activity implements View.OnClickListener {
    ...
    private Button btn_get_by_okhttputils;
    private Button btn_post_by_okhttputils;
    private Button btn_downloadfile;
    private ProgressBar mProgressBar;
    private Button btn_downloadImg;
    private ImageView iv_icon;
    private Button btn_downloadImg_list;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_get_by_okhttputils = findViewById(R.id.btn_get_by_okhttputils);
        btn_post_by_okhttputils = findViewById(R.id.btn_post_by_okhttputils);
        btn_downloadfile = findViewById(R.id.btn_downloadFile);
        mProgressBar = findViewById(R.id.mProgressBar);
        btn_downloadImg = findViewById(R.id.btn_downloadImg);
        iv_icon = findViewById(R.id.iv_icon);
        btn_downloadImg_list = findViewById(R.id.btn_downloadImg_list);
        //设置点击事件
        btn_get_post.setOnClickListener(this);
        btn_get_by_okhttputils.setOnClickListener(this);
        btn_post_by_okhttputils.setOnClickListener(this);
        btn_downloadfile.setOnClickListener(this);
        btn_downloadImg.setOnClickListener(this);
        btn_downloadImg_list.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_get_post://使用原生的okhttp请求网络数据，get和post请求
                ...
                getDataFromPost();
                break;
            case R.id.btn_get_by_okhttputils:
                getDataGetByOkhttpUtils();
                break;
            case R.id.btn_post_by_okhttputils:
                getDataPostByOkhttpUtils();
                break;
            case R.id.btn_downloadFile://下载文件
                downloadFile();
                break;
            case R.id.btn_downloadImg://下载图片
                getImage();
                break;
            case R.id.btn_downloadImg_list://加载列表图片
